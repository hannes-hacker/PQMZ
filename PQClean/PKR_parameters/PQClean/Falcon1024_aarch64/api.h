...
#define PQCLEAN_FALCON1024_AARCH64_CRYPTO_BYTES_PKR        2883
...
#define PQCLEAN_FALCONPADDED1024_AARCH64_CRYPTO_BYTES_PKR  2514 // used in signature verification
 ...
 * into *siglen. Signature length is variable; maximum signature length
 * (in bytes) is PQCLEAN_FALCON1024_AARCH64_CRYPTO_BYTES_PKR.
 *
 * sig[], m[] and sk[] may overlap each other arbitrarily.
 *
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_FALCON1024_AARCH64_crypto_sign_signature_pkr(
    uint8_t *sig, size_t *siglen,
 ...
 * Return value: 0 on success, -1 on error.
 */
int PQCLEAN_FALCON1024_AARCH64_crypto_sign_verify_pkr_recover(
    const uint8_t *sig, size_t siglen,
