...
int main(void) {
    ...
    int result_sign_pkr = PQCLEAN_FALCON512_AARCH64_crypto_sign_signature_pkr(signature_pkr, &signature_length_pkr, &message_pkr, message_length_pkr, secret_key_pkr, counter);
